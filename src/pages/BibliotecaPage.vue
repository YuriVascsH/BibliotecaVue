      ...
      <v-list dense style="margin-top: 25px">
        <template v-for="(item, index) in menuItems">
          <v-list-item :key="index" class="itens" :href="item.href">
            <v-list-item-icon>
              <v-icon :style="{ fontSize: item.iconSize }">{{
                item.icon
              }}</v-icon>
            </v-list-item-icon>
            <v-list-item-title
                      ...
                      <v-row>
                        ...
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            ...
                            label="Assunto Abordado"
                          ></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            v-model="editedItem.ensino"
...
<!-- Arquivos -->
<script src="../components/biblioteca/script"></script>
<style src="../components/biblioteca/style.css"></style>
